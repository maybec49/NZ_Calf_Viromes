...
#oral_full = read.csv("Cow_oral_full.csv", header= TRUE)
# Extract genus or next appropriate taxnomic level
#oral_full = oral_full[,c(12,14:24)]
#oral_full = oral_full %>%
#  mutate(extracted_level = sapply(taxonomy, extract_taxonomy))
#oral_full = oral_full %>%
#  select(taxonomy = extracted_level, everything(), -taxonomy)
# Merge counts by genus/taxonomy
#oral_full = aggregate(. ~ taxonomy, data = oral_full, FUN = sum)
#write.csv(oral_full, "Oral_DVAv2.csv")
...
#faecal_full = read.csv("Cow_faecal_full.csv", header= TRUE)
#faecal_full = faecal_full[,c(12,14:24)]
#faecal_full = faecal_full %>%
#  mutate(extracted_level = sapply(taxonomy, extract_taxonomy))
#faecal_full = faecal_full %>%
#  select(taxonomy = extracted_level, everything(), -taxonomy)
#faecal_full = aggregate(. ~ taxonomy, data = faecal_full, FUN = sum)
#write.csv(faecal_full, "Faecal_DVAv2.csv")
